...
parser.add_argument('--cam_link', help='CAM Link', required=True, type=str)
...
def publish(cam_link,database_path,requestor_type,privacy_parameter):
    ...
    ws_req = {
            "RequestPostTopicUUID": {
                "topic_name": "SIFIS:Privacy_Aware_Face_Recognition_CAM",
...
publish(cam_link,database_path,requestor_type,privacy_parameter)